...
-- FK를 적용하면 마음대로 삽입/삭제할 수 없다.
 -- 무결성 제약 조건 에 위배 됨 - 부모키가 없습니다.
insert into 주문테이블(주문번호, 주문고객, 주문제품, 수량, 배송지, 주문일자)
values('o12', 'banana2', 'p06', 15, '제주도', '2022-06-01');
insert into 주문테이블(주문번호, 주문고객, 주문제품, 수량, 배송지, 주문일자)
values('o12', 'melon', 'p10', 15, '제주도', '2022-06-01');

--RA-02292: 무결성 제약조건(C##NOHSSAM.FK_주문고객)이 위배되었습니다- 자식 레코드가 발견되었습니다
delete from 고객테이블 where  고객아이디 = 'apple';
delete from 제품테이블  where   제품번호 = 'p03';
-- 삭제가능 : 주문테이블에서 참조하기 않았으므로 삭제 가능
...
-- 7. 가간 구하기 : moths_between(끝날짜, 시작날짜) : 월단위
