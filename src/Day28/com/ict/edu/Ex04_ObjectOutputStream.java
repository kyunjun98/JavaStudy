...
public class Ex04_ObjectOutputStream {
	public static void main(String[] args) {
		...
		// 1. 객체 만들기
		Ex04_VO vo1 = new Ex04_VO("고둘리", 27, "서울 마포구", false, 179.5);
		Ex04_VO vo2 = new Ex04_VO("이둘리", 21, "서울 용산구", true, 170.0);
		Ex04_VO vo3 = new Ex04_VO("김둘리", 17, "서울 강남구", false, 183.3);
		Ex04_VO vo4 = new Ex04_VO("박둘리", 33, "서울 서초구", true, 165.5);
		Ex04_VO vo5 = new Ex04_VO("홍둘리", 26, "서울 중랑구", true, 173.5);
