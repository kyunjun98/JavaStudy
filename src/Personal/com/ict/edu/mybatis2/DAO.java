...
public class DAO {
	...
	public static VO getOneId(String id) {
		VO vo = getSession().selectOne("custOneId", id);
		return vo;
	}
	public static VO getOneName(String name) {
		VO vo = getSession().selectOne("custOneName", name);
		return vo;
	}
	public static VO getOneAddr(String addr) {
		VO vo = getSession().selectOne("custOneAddr", addr);
		return vo;
	}
	public static VO getOnePhone(String phone) {
		VO vo = getSession().selectOne("custOnePhone", phone);
		return vo;
	}
